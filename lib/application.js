...
cols.addMobile([{
  ...
  type: 'time',
  fmt: '%H: %M'
}, { key: 'session', wrapper: 'session-title' }, { key: 'expand', title: '' }]).addMobileOnly([{ key: 'actions', title: '' }]).addTabletNoShow(['location']).addDesktop(['instructor', 'activity']).addTabletNoShow([{ key: 'actions', title: '' }]).additional(['description']);
