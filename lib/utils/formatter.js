(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'lodash/map', 'lodash/isString', 'lodash/isUndefined', 'lodash/isDate', 'lodash/has', 'moment-strftime'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('lodash/map'), require('lodash/isString'), require('lodash/isUndefined'), require('lodash/isDate'), require('lodash/has'), require('moment-strftime'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.map, global.isString, global.isUndefined, global.isDate, global.has, global.momentStrftime);
    global.formatter = mod.exports;
  }
})(this, function (module, exports, _map2, _isString2, _isUndefined2, _isDate2, _has2, _momentStrftime) {
  'use strict';
