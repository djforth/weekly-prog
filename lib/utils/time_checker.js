(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'lodash/isNull', 'lodash/values', 'lodash/pick', 'lodash/includes', 'moment'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('lodash/isNull'), require('lodash/values'), require('lodash/pick'), require('lodash/includes'), require('moment'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.isNull, global.values, global.pick, global.includes, global.moment);
    global.time_checker = mod.exports;
  }
})(this, function (module, exports, _isNull2, _values4, _pick2, _includes2, _moment) {
  'use strict';
