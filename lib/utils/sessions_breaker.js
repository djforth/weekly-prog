...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(createKey, 'createKey', 'src/utils/sessions_breaker.js');

  __REACT_HOT_LOADER__.register(groupSessions, 'groupSessions', 'src/utils/sessions_breaker.js');

  __REACT_HOT_LOADER__.register(makeDates, 'makeDates', 'src/utils/sessions_breaker.js');

  __REACT_HOT_LOADER__.register(addDay, 'addDay', 'src/utils/sessions_breaker.js');

  __REACT_HOT_LOADER__.register(currentDates, 'currentDates', 'src/utils/sessions_breaker.js');

  __REACT_HOT_LOADER__.register(fillGaps, 'fillGaps', 'src/utils/sessions_breaker.js');
}();
