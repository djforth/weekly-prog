...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(EventEmitter, 'EventEmitter', 'src/stores/columns_store.js');

  __REACT_HOT_LOADER__.register(textMixins, 'textMixins', 'src/stores/columns_store.js');

  __REACT_HOT_LOADER__.register(store, 'store', 'src/stores/columns_store.js');

  __REACT_HOT_LOADER__.register(ColumnsStore, 'ColumnsStore', 'src/stores/columns_store.js');

  __REACT_HOT_LOADER__.register(registeredCallback, 'registeredCallback', 'src/stores/columns_store.js');
}();
