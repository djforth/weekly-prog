...
function dateManager(groupBy, ds) {
  ...
  var weekCreator = partial(createWeek, fctyCreator);
  ...
  return {
    addDate: function addDate(date, data) {
      ...
      if (checkDates(dates, date)) {
        var fn = partial(dateUpdate, dates);
        dates = fn(date, data);
      } else {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getDate, 'getDate', 'src/factories/date_manager.js');

  __REACT_HOT_LOADER__.register(checkDates, 'checkDates', 'src/factories/date_manager.js');

  __REACT_HOT_LOADER__.register(createFactory, 'createFactory', 'src/factories/date_manager.js');

  __REACT_HOT_LOADER__.register(createWeek, 'createWeek', 'src/factories/date_manager.js');

  __REACT_HOT_LOADER__.register(dateUpdate, 'dateUpdate', 'src/factories/date_manager.js');

  __REACT_HOT_LOADER__.register(getNewDate, 'getNewDate', 'src/factories/date_manager.js');

  __REACT_HOT_LOADER__.register(processForNav, 'processForNav', 'src/factories/date_manager.js');

  __REACT_HOT_LOADER__.register(_resetDates, 'resetDates', 'src/factories/date_manager.js');

  __REACT_HOT_LOADER__.register(earliestDate, 'earliestDate', 'src/factories/date_manager.js');

  __REACT_HOT_LOADER__.register(dateManager, 'dateManager', 'src/factories/date_manager.js');
}();
