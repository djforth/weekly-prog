(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'lodash/last', 'lodash/isDate', 'lodash/isArray', 'lodash/reduce', 'lodash/filter', 'lodash/map', 'lodash/find', '../utils/day_checker', './sessions_fcty', 'lodash/partial', 'moment'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('lodash/last'), require('lodash/isDate'), require('lodash/isArray'), require('lodash/reduce'), require('lodash/filter'), require('lodash/map'), require('lodash/find'), require('../utils/day_checker'), require('./sessions_fcty'), require('lodash/partial'), require('moment'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.last, global.isDate, global.isArray, global.reduce, global.filter, global.map, global.find, global.day_checker, global.sessions_fcty, global.partial, global.moment);
    global.date_manager = mod.exports;
  }
})(this, function (exports, _last2, _isDate2, _isArray2, _reduce2, _filter2, _map2, _find2, _day_checker, _sessions_fcty, _partial, _moment) {
  'use strict';
