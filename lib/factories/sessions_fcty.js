(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'lodash/includes', 'lodash/isArray', 'lodash/isDate', 'lodash/isNumber', 'datamanager', 'immutable'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('lodash/includes'), require('lodash/isArray'), require('lodash/isDate'), require('lodash/isNumber'), require('datamanager'), require('immutable'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.includes, global.isArray, global.isDate, global.isNumber, global.datamanager, global.immutable);
    global.sessions_fcty = mod.exports;
  }
})(this, function (module, exports, _includes2, _isArray2, _isDate2, _isNumber2, _datamanager, _immutable) {
  'use strict';
