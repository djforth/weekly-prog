...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(changeDate, 'changeDate', 'src/actions/sessions_actions.js');

  __REACT_HOT_LOADER__.register(calendarChange, 'calendarChange', 'src/actions/sessions_actions.js');

  __REACT_HOT_LOADER__.register(fetchData, 'fetchData', 'src/actions/sessions_actions.js');

  __REACT_HOT_LOADER__.register(fetchNowNext, 'fetchNowNext', 'src/actions/sessions_actions.js');

  __REACT_HOT_LOADER__.register(getMoreDays, 'getMoreDays', 'src/actions/sessions_actions.js');

  __REACT_HOT_LOADER__.register(getPreviousDays, 'getPreviousDays', 'src/actions/sessions_actions.js');

  __REACT_HOT_LOADER__.register(prerenderData, 'prerenderData', 'src/actions/sessions_actions.js');

  __REACT_HOT_LOADER__.register(setApi, 'setApi', 'src/actions/sessions_actions.js');

  __REACT_HOT_LOADER__.register(setFacility, 'setFacility', 'src/actions/sessions_actions.js');

  __REACT_HOT_LOADER__.register(setGroupby, 'setGroupby', 'src/actions/sessions_actions.js');
}();
