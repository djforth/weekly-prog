(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', '../dispatchers/columns_dispatcher'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('../dispatchers/columns_dispatcher'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.columns_dispatcher);
    global.columns_actions = mod.exports;
  }
})(this, function (exports, _columns_dispatcher) {
  'use strict';
