...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(addingColumns, 'addingColumns', 'src/actions/columns_actions.js');

  __REACT_HOT_LOADER__.register(changeDevice, 'changeDevice', 'src/actions/columns_actions.js');
}();
