...
var Heading = require('./simple/heading');
...
var DataHead = function (_React$Component) {
  ...
  function DataHead(props) {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(DataHead).call(this, props));
  }
  ...
  _createClass(DataHead, [{
    ...
    value: function renderTh() {
      if (this.props.columns) {
        var th = _.map(this.props.columns, function (col, i) {
