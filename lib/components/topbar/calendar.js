...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Calendar, 'Calendar', 'src/components/topbar/calendar.js');

  __REACT_HOT_LOADER__.register(theme, 'theme', 'src/components/topbar/calendar.js');

  __REACT_HOT_LOADER__.register(CalendarHolder, 'CalendarHolder', 'src/components/topbar/calendar.js');
}();
