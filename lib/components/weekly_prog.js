(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'lodash/map', 'lodash/isEmpty', 'lodash/defer', 'react', 'moment', 'morse-react-mixins', 'viewport-detection-es6', '../actions/columns_actions', '../actions/sessions_actions', '../stores/sessions_store', './nav/date_nav', './sessions/period_sessions', './topbar/top_bar', 'moment/locale/cy'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('lodash/map'), require('lodash/isEmpty'), require('lodash/defer'), require('react'), require('moment'), require('morse-react-mixins'), require('viewport-detection-es6'), require('../actions/columns_actions'), require('../actions/sessions_actions'), require('../stores/sessions_store'), require('./nav/date_nav'), require('./sessions/period_sessions'), require('./topbar/top_bar'), require('moment/locale/cy'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.map, global.isEmpty, global.defer, global.react, global.moment, global.morseReactMixins, global.viewportDetectionEs6, global.columns_actions, global.sessions_actions, global.sessions_store, global.date_nav, global.period_sessions, global.top_bar, global.cy);
    global.weekly_prog = mod.exports;
  }
})(this, function (exports, _map2, _isEmpty2, _defer2, _react, _moment, _morseReactMixins, _viewportDetectionEs, _columns_actions, _sessions_actions, _sessions_store, _date_nav, _period_sessions, _top_bar) {
  'use strict';
