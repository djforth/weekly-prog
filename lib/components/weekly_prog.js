...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(cssMixins, 'cssMixins', 'src/components/weekly_prog.js');

  __REACT_HOT_LOADER__.register(textMixins, 'textMixins', 'src/components/weekly_prog.js');

  __REACT_HOT_LOADER__.register(widthsMixins, 'widthsMixins', 'src/components/weekly_prog.js');

  __REACT_HOT_LOADER__.register(WeeklyProg, 'WeeklyProg', 'src/components/weekly_prog.js');
}();
