    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Calendar, { device: this.state.device }),
          React.createElement(PrintBtn, { print: this.props.print })
        ),
        React.createElement(DateNav, { device: this.state.device }),
        React.createElement(
          "div",
