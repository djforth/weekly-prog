...
var DateNavItem = (function (_React$Component) {
  ...
  function DateNavItem(props) {
    ...
    _this.state = { list: _this.getClasses(_this.listCss), link: _this.getClasses(_this.linkCss) };
    return _this;
  }
  ...
  _createClass(DateNavItem, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return nextProps.active !== this.props.active || nextProps.nav_item.nosessions !== this.props.nav_item.nosessions;
    }
  }, {
    key: "render",
