  ...
  _createClass(DataItem, [{
    ...
    value: function _actions(col) {
      ...
      if (item.has("buttons") && item.get("buttons").has("book")) {
        ...
        return link === "#" || _.isEmpty(link) ? this._nobooking() : React.createElement(
          "a",
    ...
    key: "_cancelled",
    value: function _cancelled(value) {
      return React.createElement(
        "span",
        { title: "The session between " + value + " is cancelled" },
        "Cancelled"
      );
    }
  }, {
    ...
    value: function _showValues(col) {
      ...
      var time = checker.setNowOrPast("This session has started", "This session has finished", "This sessions runs between " + value);
      return React.createElement(
        "span",
        { title: time },
        value
