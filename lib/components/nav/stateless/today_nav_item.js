(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', './today_display'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('./today_display'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.today_display);
    global.today_nav_item = mod.exports;
  }
})(this, function (exports, _react, _today_display) {
  'use strict';
