(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', './day_display'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('./day_display'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.day_display);
    global.nav_item = mod.exports;
  }
})(this, function (exports, _react, _day_display) {
  'use strict';
