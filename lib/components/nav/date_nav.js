...
var NavItem = require('./stateless/nav_item'),
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(cssMixins, 'cssMixins', 'src/components/nav/date_nav.js');

  __REACT_HOT_LOADER__.register(textMixins, 'textMixins', 'src/components/nav/date_nav.js');

  __REACT_HOT_LOADER__.register(widthsMixins, 'widthsMixins', 'src/components/nav/date_nav.js');

  __REACT_HOT_LOADER__.register(DateNav, 'DateNav', 'src/components/nav/date_nav.js');
}();
