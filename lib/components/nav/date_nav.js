(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'lodash/find', 'lodash/map', 'lodash/first', 'lodash/clone', 'lodash/reduce', 'lodash/isEmpty', 'lodash/isDate', 'lodash/reject', 'lodash/mapValues', 'lodash/take', 'react', '../../utils/day_checker', 'morse-react-mixins', '../../actions/sessions_actions', '../../stores/sessions_store', '../../stores/columns_store', './stateless/arrow_left', './stateless/arrow_right', './stateless/nav_item', './stateless/today_nav_item'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('lodash/find'), require('lodash/map'), require('lodash/first'), require('lodash/clone'), require('lodash/reduce'), require('lodash/isEmpty'), require('lodash/isDate'), require('lodash/reject'), require('lodash/mapValues'), require('lodash/take'), require('react'), require('../../utils/day_checker'), require('morse-react-mixins'), require('../../actions/sessions_actions'), require('../../stores/sessions_store'), require('../../stores/columns_store'), require('./stateless/arrow_left'), require('./stateless/arrow_right'), require('./stateless/nav_item'), require('./stateless/today_nav_item'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.find, global.map, global.first, global.clone, global.reduce, global.isEmpty, global.isDate, global.reject, global.mapValues, global.take, global.react, global.day_checker, global.morseReactMixins, global.sessions_actions, global.sessions_store, global.columns_store, global.arrow_left, global.arrow_right, global.nav_item, global.today_nav_item);
    global.date_nav = mod.exports;
  }
})(this, function (exports, _find2, _map2, _first2, _clone2, _reduce2, _isEmpty2, _isDate2, _reject2, _mapValues2, _take2, _react, _day_checker, _morseReactMixins, _sessions_actions, _sessions_store, _columns_store, _arrow_left, _arrow_right, _nav_item, _today_nav_item) {
  'use strict';
