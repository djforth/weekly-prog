(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'lodash/map', 'lodash/reject', 'lodash/isEmpty', 'lodash/filter', 'react', '../../stores/columns_store', 'morse-react-mixins', '../../helpers/buttons_helper', './stateless/additional_content', './stateless/book_btn', './stateless/description', './stateless/richtext'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('lodash/map'), require('lodash/reject'), require('lodash/isEmpty'), require('lodash/filter'), require('react'), require('../../stores/columns_store'), require('morse-react-mixins'), require('../../helpers/buttons_helper'), require('./stateless/additional_content'), require('./stateless/book_btn'), require('./stateless/description'), require('./stateless/richtext'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.map, global.reject, global.isEmpty, global.filter, global.react, global.columns_store, global.morseReactMixins, global.buttons_helper, global.additional_content, global.book_btn, global.description, global.richtext);
    global.additional = mod.exports;
  }
})(this, function (module, exports, _map2, _reject2, _isEmpty2, _filter2, _react, _columns_store, _morseReactMixins, _buttons_helper, _additional_content, _book_btn, _description, _richtext) {
  'use strict';
