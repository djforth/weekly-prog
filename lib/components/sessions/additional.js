...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(cssMixins, 'cssMixins', 'src/components/sessions/additional.js');

  __REACT_HOT_LOADER__.register(textMixins, 'textMixins', 'src/components/sessions/additional.js');

  __REACT_HOT_LOADER__.register(Additional, 'Additional', 'src/components/sessions/additional.js');
}();
