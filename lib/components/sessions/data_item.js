(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'lodash/isEmpty', 'lodash/includes', 'lodash/map', 'react', '../../stores/columns_store', '../../utils/formatter', '@morsedigital/i18n_helper', 'morse-react-mixins', './column_item', './stateless/expand_btn'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('lodash/isEmpty'), require('lodash/includes'), require('lodash/map'), require('react'), require('../../stores/columns_store'), require('../../utils/formatter'), require('@morsedigital/i18n_helper'), require('morse-react-mixins'), require('./column_item'), require('./stateless/expand_btn'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.isEmpty, global.includes, global.map, global.react, global.columns_store, global.formatter, global.i18n_helper, global.morseReactMixins, global.column_item, global.expand_btn);
    global.data_item = mod.exports;
  }
})(this, function (exports, _isEmpty2, _includes2, _map2, _react, _columns_store, _formatter, _i18n_helper, _morseReactMixins, _column_item, _expand_btn) {
  'use strict';
