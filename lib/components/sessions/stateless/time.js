(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', './cancelled'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('./cancelled'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.cancelled);
    global.time = mod.exports;
  }
})(this, function (exports, _react, _cancelled) {
  'use strict';
