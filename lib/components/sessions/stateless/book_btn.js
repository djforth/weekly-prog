(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'lodash/isNumber', 'lodash/isEmpty', 'react', '@morsedigital/i18n_helper'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('lodash/isNumber'), require('lodash/isEmpty'), require('react'), require('@morsedigital/i18n_helper'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.isNumber, global.isEmpty, global.react, global.i18n_helper);
    global.book_btn = mod.exports;
  }
})(this, function (module, exports, _isNumber2, _isEmpty2, _react, _i18n_helper) {
  'use strict';
