(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'lodash/uniqueId', 'lodash/isString', 'react', '../../helpers/buttons_helper', '../../utils/time_checker', '../../utils/formatter', './stateless/book_btn', './stateless/time', './stateless/richtext', './stateless/wrapper', 'morse-react-mixins'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('lodash/uniqueId'), require('lodash/isString'), require('react'), require('../../helpers/buttons_helper'), require('../../utils/time_checker'), require('../../utils/formatter'), require('./stateless/book_btn'), require('./stateless/time'), require('./stateless/richtext'), require('./stateless/wrapper'), require('morse-react-mixins'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.uniqueId, global.isString, global.react, global.buttons_helper, global.time_checker, global.formatter, global.book_btn, global.time, global.richtext, global.wrapper, global.morseReactMixins);
    global.column_item = mod.exports;
  }
})(this, function (module, exports, _uniqueId2, _isString2, _react, _buttons_helper, _time_checker, _formatter, _book_btn, _time, _richtext, _wrapper, _morseReactMixins) {
  'use strict';
