...
var ButtonCheck = require('../../helpers/buttons_helper');
...
var ColumnItem = function (_React$Component) {
  ...
  _createClass(ColumnItem, [{
    ...
    value: function _actions() {
      ...
      var link = _ButtonCheck.link;
      var title = _ButtonCheck.title;
      var instruction = _ButtonCheck.instruction;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(cssMixins, 'cssMixins', 'src/components/sessions/column_item.js');

  __REACT_HOT_LOADER__.register(textMixins, 'textMixins', 'src/components/sessions/column_item.js');

  __REACT_HOT_LOADER__.register(ColumnItem, 'ColumnItem', 'src/components/sessions/column_item.js');
}();
