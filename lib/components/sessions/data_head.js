...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(cssMixins, 'cssMixins', 'src/components/sessions/data_head.js');

  __REACT_HOT_LOADER__.register(textMixins, 'textMixins', 'src/components/sessions/data_head.js');

  __REACT_HOT_LOADER__.register(DataHead, 'DataHead', 'src/components/sessions/data_head.js');
}();
