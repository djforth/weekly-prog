  ...
  _createClass(DataExpanderItem, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(DataItem, { css: this.props.css, data: this.props.data, expand: this._onClick.bind(this) }),
        React.createElement(Additional, { data: this.props.data, active: this.state.active, info: this.state.info })
      );
    }
  }]);
