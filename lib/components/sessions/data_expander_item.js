(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'lodash/isBoolean', 'lodash/map', 'lodash/reject', 'lodash/includes', 'react', '../../stores/columns_store', './additional', './data_item', 'morse-react-mixins'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('lodash/isBoolean'), require('lodash/map'), require('lodash/reject'), require('lodash/includes'), require('react'), require('../../stores/columns_store'), require('./additional'), require('./data_item'), require('morse-react-mixins'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.isBoolean, global.map, global.reject, global.includes, global.react, global.columns_store, global.additional, global.data_item, global.morseReactMixins);
    global.data_expander_item = mod.exports;
  }
})(this, function (exports, _isBoolean2, _map2, _reject2, _includes2, _react, _columns_store, _additional, _data_item, _morseReactMixins) {
  'use strict';
