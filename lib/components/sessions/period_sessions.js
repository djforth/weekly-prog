(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', './data_head', './data_expander_item', './stateless/no_sessions', './stateless/paginate', './stateless/period_head', '../../stores/columns_store', '../../stores/sessions_store', 'morse-react-mixins'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('./data_head'), require('./data_expander_item'), require('./stateless/no_sessions'), require('./stateless/paginate'), require('./stateless/period_head'), require('../../stores/columns_store'), require('../../stores/sessions_store'), require('morse-react-mixins'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.data_head, global.data_expander_item, global.no_sessions, global.paginate, global.period_head, global.columns_store, global.sessions_store, global.morseReactMixins);
    global.period_sessions = mod.exports;
  }
})(this, function (exports, _react, _data_head, _data_expander_item, _no_sessions, _paginate2, _period_head, _columns_store, _sessions_store, _morseReactMixins) {
  'use strict';
