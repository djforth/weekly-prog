...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(cssMixins, 'cssMixins', 'src/components/sessions/period_sessions.js');

  __REACT_HOT_LOADER__.register(textMixins, 'textMixins', 'src/components/sessions/period_sessions.js');

  __REACT_HOT_LOADER__.register(PeriodSessions, 'PeriodSessions', 'src/components/sessions/period_sessions.js');
}();
