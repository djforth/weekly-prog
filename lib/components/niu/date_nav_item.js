...
var DateNavItem = function (_React$Component) {
  ...
  function DateNavItem(props) {
    ...
    var _this = _possibleConstructorReturn(this, (DateNavItem.__proto__ || Object.getPrototypeOf(DateNavItem)).call(this, props));

    if (!_.isBoolean(_this.props.active)) alert(_this.props.active);
    _this.listCss = ['date-nav-item', { 'active': _this.props.active }];
    _this.linkCss = ['date-nav-item-link', { 'loading-session': false }];
    _this.state = { list: _this.getClasses(_this.listCss), device: ColumnsStore.getDevice() };
    return _this;
  }
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(cssMixins, 'cssMixins', 'src/components/niu/date_nav_item.js');

  __REACT_HOT_LOADER__.register(textMixins, 'textMixins', 'src/components/niu/date_nav_item.js');

  __REACT_HOT_LOADER__.register(DateNavItem, 'DateNavItem', 'src/components/niu/date_nav_item.js');
}();
