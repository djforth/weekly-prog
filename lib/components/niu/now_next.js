...
var NowNext = function (_React$Component) {
  ...
  function NowNext(props) {
    ...
    var _this = _possibleConstructorReturn(this, (NowNext.__proto__ || Object.getPrototypeOf(NowNext)).call(this, props));
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(cssMixins, 'cssMixins', 'src/components/niu/now_next.js');

  __REACT_HOT_LOADER__.register(textMixins, 'textMixins', 'src/components/niu/now_next.js');

  __REACT_HOT_LOADER__.register(widthsMixins, 'widthsMixins', 'src/components/niu/now_next.js');

  __REACT_HOT_LOADER__.register(NowNext, 'NowNext', 'src/components/niu/now_next.js');
}();
