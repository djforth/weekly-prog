...
var NowNextSessions = function (_DataItems) {
  ...
  function NowNextSessions(props) {
    ...
    var _this = _possibleConstructorReturn(this, (NowNextSessions.__proto__ || Object.getPrototypeOf(NowNextSessions)).call(this, props));
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(cssMixins, 'cssMixins', 'src/components/niu/nownext_sessions.js');

  __REACT_HOT_LOADER__.register(NowNextSessions, 'NowNextSessions', 'src/components/niu/nownext_sessions.js');
}();
