...
var TodayItem = function (_DateNavItem) {
  ...
  function TodayItem(props) {
    ...
    var _this = _possibleConstructorReturn(this, (TodayItem.__proto__ || Object.getPrototypeOf(TodayItem)).call(this, props));
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TodayItem, 'TodayItem', 'src/components/niu/today_nav_item.js');
}();
